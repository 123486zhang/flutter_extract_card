...
/// 经典Footer
class MyClassicalFooter extends Footer {
  /// Key
  final Key key;
  ...
  Widget contentBuilder(
      ...
      bool success,
      bool noMore) {
    return MyClassicalFooterWidget(
      key: key,
...
/// 经典Footer组件
class MyClassicalFooterWidget extends StatefulWidget {
  final MyClassicalFooter classicalFooter;
  ...
  @override
  MyClassicalFooterWidgetState createState() => MyClassicalFooterWidgetState();
}

class MyClassicalFooterWidgetState extends State<MyClassicalFooterWidget>
    with TickerProviderStateMixin<MyClassicalFooterWidget> {
  // 是否到达触发加载距离
